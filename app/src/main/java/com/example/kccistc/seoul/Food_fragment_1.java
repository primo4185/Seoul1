...
public class Food_fragment_1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.food_fragment_1, null);
    ...
    private void parseJSON() {
        String url = "http://primo4185.com/test";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject responses) {   // json 반응 함수
                        try {
                            ...
                            JSONArray jsonArray = responses.getJSONArray("gm");
